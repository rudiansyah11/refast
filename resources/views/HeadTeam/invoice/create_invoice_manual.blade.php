                ...
                <div class="col-lg-12">
                    <div class="panel panel-flat">
                        <div class="panel-heading">
                            <h5 class="panel-title">Buat Invoice Manual</h5>
                            <div class="heading-elements">
                                <ul class="icons-list">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" id="form-submit" action="{{ route('HeadTeam.processmanualinvoice') }}" method="POST">
                                @csrf
                                ...
                                <fieldset class="content-group">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group @error('nominal_pembayaran_invoice') has-warning has-feedback @enderror">
                                                <label class="control-label col-lg-4">Nominal Pembayaran: <span class="text-danger">*</span></label>
                                                <div class="col-lg-8">
                                                    <input type="text" name="nominal_pembayaran_invoice" id="nominal_pembayaran_invoice" class="form-control input-xs" required placeholder="Nominal pembayaran input tanpa pemisah titik atau koma.">
                                                    @error('nominal_pembayaran_invoice')
...
<script>
    ...
    var nominal_pembayaran_invoice = document.getElementById('nominal_pembayaran_invoice');
    nominal_pembayaran_invoice.addEventListener('keyup', function(e) {
        nominal_pembayaran_invoice.value = formatRupiah(this.value);
    });
